...
int CBaseMonster::IRelationship(CBaseEntity* pTarget)
{
	static int iEnemy[15][15] =
		{//   NONE	 MACH	 PLYR	 HPASS	 HMIL	 AMIL	 APASS	 AMONST	APREY	 APRED	 INSECT	PLRALY	PBWPN	ABWPN
			...
			/*HUMANPASSIVE*/ {R_NO, R_NO, R_AL, R_AL, R_HT, R_HT, R_NO, R_HT, R_DL, R_DL, R_NO, R_AL, R_NO, R_NO, R_HT},
			...
			/*HUMANBLACKOPS*/ {R_NO, R_NO, R_HT, R_DL, R_HT, R_HT, R_DL, R_DL, R_DL, R_DL, R_NO, R_HT, R_NO, R_NO, R_NO}};
